...
const BuyFaircodeModal: React.FC<BuyFaircodeModalProps> = ({ onBack, user }) => {
  ...
  const handleCopyAccountNumber = () => {
    enableSpeech();
    navigator.clipboard.writeText('0124340332').then(() => {
      toast({
        title: "Copied!",
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                    <div>
                      ...
                      <p className="font-semibold text-sm">0124340332</p>
                    </div>
                    <button
                  ...
                  <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                    <div>
                      ...
                      <p className="font-semibold text-sm">SMART CASH</p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                    <div>
                      ...
                      <p className="font-semibold text-sm">VINCENT ALFRED</p>
                    </div>
                  </div>
                </div>
